...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "Automated data quality monitoring for CSV/Parquet files with missing‑value detection, drift analysis, and outlier alerts. Provides interactive dashboards and a quality score to prioritize remediation.",
      technologies: [
        "FastAPI",
        "Python",
        "Pandas",
